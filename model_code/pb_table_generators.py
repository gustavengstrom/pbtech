...
def param_elast_table():
    with open("./model_code/params_elast_table.txt", "r") as f:
        pars = {**param_dict}
...
def param_qshare_table():
    with open("./model_code/params_qshare_table.txt", "r") as f:
...
def param_expshare_table():
    ...
    with open("./model_code/params_expshare_table.txt", "r") as f:
        pars = {**param_dict, **derived_params()}
        for line in f.readlines():
            pline = line.replace("\n", "")
            for k, v in pars.items():
